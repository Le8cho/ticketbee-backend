...
def test_pago_exitoso_llama_al_backend():
    ...
    assert resultado["fecha_vencimiento"] == "2026-07-06T00:00:00+00:00"  # +14 dias
    ...
    assert kwargs["json"]["fecha_vencimiento"] == "2026-07-06T00:00:00+00:00"
    ...
    print("[OK] Llama al backend con la fecha correcta (+14 dias), el JWT, y manda el email\n")
